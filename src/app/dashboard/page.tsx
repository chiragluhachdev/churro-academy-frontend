...
export default function DashboardOverviewPage() {
  ...
  return (
    <div className="space-y-14">
      <Reveal>
        <DashboardHeader
          eyebrow={`Welcome back, ${student.firstName}`}
          title="Let's get baking."
          lede={`You're ${stats.overallProgress}% through everything you've enrolled in. Nice pace.`}
        />
      </Reveal>
          ...
          <div className="border-line/80 bg-forest-deep text-cream mt-5 grid overflow-hidden rounded-2xl border sm:grid-cols-[38fr_62fr]">
            ...
            <div className="flex flex-col justify-center p-7 sm:p-9">
              ...
              <p className="text-cream/75 mt-3 text-[0.9rem]">
                Next up — {continueCourse.nextLesson}
              </p>
              ...
              <Link
                href={`/courses/${continueCourse.course.slug}`}
      ...
      <section>
        ...
        <ul className="mt-7 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {inProgress.map((entry, index) => (
            <Reveal as="li" key={entry.courseSlug} delay={(index % 3) * 0.06}>
              <Link
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-auto pt-5">
                    ...
                    />
                    <p className="text-muted mt-2.5 text-[0.78rem]">
